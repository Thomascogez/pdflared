/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 6f295c474b3d03fd3c7072805ee793a2)
// Runtime types generated with workerd@1.20251210.0 2025-12-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BrowserRenderingDo";
	}
	interface Env {
		API_KEY: string;
		BROWSER_RENDERING_DO: DurableObjectNamespace<
			typeof import("./src/index")["BrowserRenderingDo"]
		> /* BrowserRenderingDo */;
		BUCKET: R2Bucket;
		DB: D1Database;
		BROWSER: Fetcher;
